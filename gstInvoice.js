...
const repeatBillerData = [
  { label: "Biller", value: "RATNASHIL ONLINE SERVICES PRIVATE LIMITED" },
  {
    label: "Address",
...
const repeatSellerData = [
  { label: "Seller", value: "9027914004" },
  {
    label: "Address",
...
const repeatBuyerData = [
  { label: "Buyer", value: "Chainstart Autopart" },
  {
    label: "Address",
    value: "Raghunathganj-II, Murshidabad, West Bengal - 742213",
  },
...
const drawHeaderColumns = (doc, billerData, sellerData, buyerData) => {
  const x = 20;
  const y = 120;
  const boxWidth = 550;
